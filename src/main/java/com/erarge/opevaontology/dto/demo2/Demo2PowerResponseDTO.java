...
public class Demo2PowerResponseDTO {
    ...
    public Demo2PowerSummaryDTO getSummary() { return summary; }
    public void setSummary(Demo2PowerSummaryDTO summary) { this.summary = summary; }

    public List<Demo2PowerPointDTO> getPoints() { return points; }
    public void setPoints(List<Demo2PowerPointDTO> points) { this.points = points; }
}