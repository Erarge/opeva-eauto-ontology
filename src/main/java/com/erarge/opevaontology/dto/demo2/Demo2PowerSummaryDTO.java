...
public class Demo2PowerSummaryDTO {
    ...
    public double getMinPowerW() { return minPowerW; }
    public void setMinPowerW(double minPowerW) { this.minPowerW = minPowerW; }

    public double getMaxPowerW() { return maxPowerW; }
    public void setMaxPowerW(double maxPowerW) { this.maxPowerW = maxPowerW; }

    public double getAveragePowerW() { return averagePowerW; }
    public void setAveragePowerW(double averagePowerW) { this.averagePowerW = averagePowerW; }
}