...
public class Demo3SummaryResponse {
    ...
    public void setBatteryCount(long batteryCount) {
        this.batteryCount = batteryCount;
    }

    public long getSocCount() {
        return socCount;
    }

    public void setSocCount(long socCount) {
        this.socCount = socCount;
    }
    ...
    public Double getMaxImpedanceMagnitude() {
        return maxImpedanceMagnitude;
    }

    public void setMaxImpedanceMagnitude(Double maxImpedanceMagnitude) {
        this.maxImpedanceMagnitude = maxImpedanceMagnitude;
    }
    ...
    public void setAveragePhase(Double averagePhase) {
        this.averagePhase = averagePhase;
    }
}
