...
public class APIController {
    ...
    @GetMapping("/api/demo9/active-power-series")
    public ResponseEntity<Demo9ActivePowerResponseDTO> getDemo9ActivePowerSeries() {
        return ResponseEntity.ok(service.getDemo9ActivePowerSeries());
    }
}
