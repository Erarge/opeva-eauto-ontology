...
public class KpisResponse {
    ...
    public long getChargingStations() { return chargingStations; }
    public void setChargingStations(long chargingStations) { this.chargingStations = chargingStations; }
    public long getDepots() { return depots; }
    public void setDepots(long depots) { this.depots = depots; }
